...
import { supplementsRoute } from './routes/supplements';
import { specialsRoute } from './routes/specials';
...
app.route("/supplements", supplementsRoute);
app.route('/specials', specialsRoute);
